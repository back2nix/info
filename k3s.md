...
curl -sfL https://get.k3s.io | sh -s - server --token=K10***REDACTED*** --tls-san 10.177.11.52
...
curl -sfL https://get.k3s.io | K3S_URL=https://10.177.11.52:6443 K3S_TOKEN=K10***REDACTED*** sh -
